...
\item [$a$]
  Se define como $a:= W_S/E[\tau]$ la intensidad de tráfico. Por tnto $\rho = \frac{a}{c}$
\end{itemize}

\section{Modelos particulares}
\subsection{D/D/1}
Tenemos una frecuencia constante de llegadas $\lambda$ y una frecuencia constante de servicio $\mu$. Esto quiere
decir que tenemos unos tiempos entre llegadas de $\frac{1}{\lambda}$ y unos tiempos de servicio constantes $S=\frac{1}{\mu}$.

El aprovechamiento sería de $a=\frac{\lambda}{\mu}$, la intensidad de tráfico, $\rho = a$
