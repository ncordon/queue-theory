...
%% TODO: terminar de detallar las medidas
\begin{itemize}
\item [$\rho$]
  Aprovechamiento de los servidores, esto es, la proporción de tiempo que los servidores están trabajando: $\rho = \frac{\lambda}{c\mu}$. Cuanto más alta mejor es la eficiencia de los servidores, pero si $\rho > 1$ significa que el sistema esté sobrecargado y se acumularán clientes en la cola progresivamente.
\item [$W_W$]
  Tiempo medio de un cliente en el sistema.
\item [$W_Q$]
  Tiempo medio de un cliente en la cola.
\item [$\pi_{W_W} \lbrack 90 \rbrack$]
  Percentil 90 de el tiempo total en el sistema $W_W$.
\item [$\pi_{W_Q} \lbrack 90 \rbrack$]
  Percentil 90 de el tiempo de espera en la cola $W_Q$.
\item [$L$]
